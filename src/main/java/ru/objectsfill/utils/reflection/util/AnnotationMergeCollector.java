package ru.objectsfill.utils.reflection.util;

import ru.objectsfill.utils.reflection.ReflectionUtils;
...
import static ru.objectsfill.utils.reflection.ReflectionUtils.toMap;


/**
 * merge annotations by mapping {@link ReflectionUtils#toMap(Annotation)}
 ...
 * <p>optional {@code annotatedElement} used by {@link ReflectionUtils#toMap(Annotation, AnnotatedElement)}
